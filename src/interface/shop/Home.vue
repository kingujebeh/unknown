  ...
  >
    <div>
      <div class="flex items-center bg-white p-4 pb-2 justify-between">
        <h2
          class="text-[#111518] text-lg font-bold leading-tight tracking-[-0.015em] flex-1 text-center pl-12"
        >
          Osas Engineering
        </h2>
        <div class="flex w-12 items-center justify-end">
          <button
            class="flex max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 bg-transparent text-[#111518] gap-2 text-base font-bold leading-normal tracking-[0.015em] min-w-0 p-0"
          >
            <div
              class="text-[#111518]"
              data-icon="Gear"
      ...
      <div class="@container">
        <div class="@[480px]:px-4 @[480px]:py-3">
          <div
            ...
            style="
              background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuD4PcnONaAN7h79C6GtH8S8mXt6ZEtDmYyxFrOX0xVhDXAQf606b56eHdcrVUYLGpM1i2paY68yG1SOniJf3UzW6m362Dzom-157v1No-BANPaD9ulLkLIsZyLRa6qIK-8nENXJVKod7XKY_6NWbXiiIkqMtn7ckv0b6gUUQ6RNukjp2wjSEq4GpLA5unpbliYOXDvpowTJuE1ItHwsyTcJZq_L2WUP0nPoX5SbRKm8AVODptY_CzNn8se2Elq1-SkAY8jbyMwAoPy7');
            "
          ></div>
        </div>
      </div>
      <div class="flex px-4 py-3">
        <button
          class="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5 flex-1 bg-[#2597f4] text-white text-base font-bold leading-normal tracking-[0.015em]"
        >
          <span class="truncate">Schedule a Repair</span>
        </button>
      </div>
      <h2
        class="text-[#111518] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5"
      >
        Our Services
      </h2>
      <div
      ...
      >
        <div
          class="flex flex-1 gap-3 rounded-lg border border-[#dbe1e6] bg-white p-4 items-center"
        >
          <div
            class="text-[#111518]"
            data-icon="Wrench"
        ...
        <div class="flex flex-col gap-3 bg-white">
          <div class="flex items-center gap-3">
            <div
              ...
              style="
                background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuAKEIIj0qXqA4cZZRKZaTQVkZpEIpYHsoxuIaYpMz3ACXSFOfJnGS-zbQjVlCYcURPvQfvcqw5SfJyELdE6K_b-uE-bwGo4Z4scbt6Eynvs6vHKYH0SGWseNx54JpQgBhVzpzYsEaLcppAa2iD49t39g7jzMh0KxYuz7fAabB5GysTAAXABroR4L9f9uWInTyuSEr8fV_bpqTaZE_Q44zOmtL0JNXURHeEzD9BbzNo5iEX5Crf-nriLGg-IDn1RLu5OaDlaSjR5J-Pk');
              "
            ></div>
            <div class="flex-1">
              ...
              <p class="text-[#60778a] text-sm font-normal leading-normal">
                2 months ago
              </p>
            </div>
          </div>
        ...
        <div class="flex flex-col gap-3 bg-white">
          <div class="flex items-center gap-3">
            <div
              class="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10"
              style="
                background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuBNyvt1xCY7KraPGCKFLFc4B4BGfEVP6585oM93bmsDysQhCae_7bZY44qItHWR0XTZWCl7DaZvHYnmdWoDzKUlE2VLzVs9JyT3L9Mf3cY-W4VxOWam7yeOBkrVm9YEvrHULM__7V6UW1o1jaCD5dFZ06FlgweL9DKcmaAqF1zs-QklL_jnW5IaM1QfXU3kc8wLy9WwzxbP7O4ZGsrRKmRDRdpoNwK-bvS_0m40lmef3fKCBrwPAEF3HuQXtH3McKn-A2t-tFf_1Cdo');
              "
            ></div>
            <div class="flex-1">
              <p class="text-[#111518] text-base font-medium leading-normal">
          ...
          <p class="text-[#111518] text-base font-normal leading-normal">
            I had a great experience with Osas Engineering. They repaired my
            laptop efficiently, and the technician was very knowledgeable.
          </p>
          <div class="flex gap-9 text-[#60778a]">
            <button class="flex items-center gap-2">
              <div
      ...
      <div class="flex items-center gap-4 bg-white px-4 min-h-[72px] py-2">
        <div
          class="text-[#111518] flex items-center justify-center rounded-lg bg-[#f0f2f5] shrink-0 size-12"
          data-icon="Phone"
          data-size="24px"
          data-weight="regular"
        >
        ...
        <div class="flex flex-col justify-center">
          <p
            class="text-[#111518] text-base font-medium leading-normal line-clamp-1"
          >
            Phone
          </p>
          <p
            class="text-[#60778a] text-sm font-normal leading-normal line-clamp-2"
          >
            (555) 123-4567
          </p>
        </div>
    ...
    <div>
      <div class="flex gap-2 border-t border-[#f0f2f5] bg-white px-4 pb-3 pt-2">
        <a
          class="just flex flex-1 flex-col items-center justify-end gap-1 rounded-full text-[#111518]"
          href="#"
        >
          <div
            class="text-[#111518] flex h-8 items-center justify-center"
            data-icon="House"
            data-size="24px"
            data-weight="fill"
          >
          ...
          <p
            class="text-[#111518] text-xs font-medium leading-normal tracking-[0.015em]"
          >
            Home
          </p>
        </a>
        ...
        >
          <div
            class="text-[#60778a] flex h-8 items-center justify-center"
            data-icon="Wrench"
            data-size="24px"
            data-weight="regular"
          >
          ...
          <p
            class="text-[#60778a] text-xs font-medium leading-normal tracking-[0.015em]"
          >
            Services
          </p>
        </a>
